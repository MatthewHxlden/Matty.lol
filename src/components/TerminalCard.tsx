  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className={`border border-border/60 bg-background/80 backdrop-blur-md neon-border shine-hover ${className}`}
      >
        {title && (
          <div className="border-b border-border/60 bg-background/60 px-4 py-2 flex items-center gap-2">
