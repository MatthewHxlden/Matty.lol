      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-2xl mx-auto my-6 bg-card border border-primary neon-border max-h-[calc(100vh-3rem)] overflow-hidden"
          >
            {/* Terminal Header */}
            ...
            <div
              ref={terminalRef}
              className="max-h-[calc(100vh-9rem)] overflow-y-auto p-4 font-mono text-sm"
