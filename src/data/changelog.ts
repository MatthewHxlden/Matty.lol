...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Fixed blog command loader freezes and ensured typewriter onComplete callbacks progress reliably.",
      "Styled blog tags with their configured colours and made them clickable to filter posts by tag.",
      "Corrected blog post share metadata (Open Graph/Twitter) to use post title and cover image.",
